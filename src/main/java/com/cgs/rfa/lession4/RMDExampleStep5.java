...
public class RMDExampleStep5 {
  ...
  *创建构造函数
  * */
  public RMDExampleStep5(String sessionName){
    /*
    * 初始化汤森路透的链接配置
    * */
  ...
  * */
  public void sendMarketPriceRequest(String serviceName,String itemName){
    ...
    intSpec.setMsg(msg);
    Client client = new MarketPriceClient();
  ...
  public static void main(String[] args) {
    ...
    RMDExampleStep5 app = new RMDExampleStep5(sessionName);
